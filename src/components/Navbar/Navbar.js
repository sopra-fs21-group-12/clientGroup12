...
import "./Navbar.css"
import finder from"./../../static/FinderLogo.svg"
    ...
    <ul class="navbar-nav">
      <li class="logo">
        <a href="#" class="nav-link">
          <span class="link-text logo-text">finder.</span> 
          <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fad"
      ...
      <li class="nav-item">
        <a href="/profile" class="nav-link">
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 448 512"
            class="svg-inline--fa fa-user fa-w-20 fa-5x"
          >
            <g class="fa-group">
              <path
                fill="currentColor"
          ...
          <span class="link-text">Userprofile</span>
        </a>
      </li>
      ...
      <li class="nav-item">
        <a href="/inventory" class="nav-link">
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 576 512"
            class="svg-inline--fa fa-box fa-w-16 fa-10x"
          >
            <g class="fa-group">
              <path
                fill="currentColor"
      ...
      <li class="nav-item">
        <a href="/itemsToChat" class="nav-link">
          <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fad"
            ...
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
            class="svg-inline--fa fa-comment fa-w-18 fa-9x"
          >
            <g class="fa-group">
              <path
                fill="currentColor"
      ...
      <li class="nav-item" id="themeButton">
        <a href="#" class="nav-link">
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
            class="svg-inline--fa question-circle fa-w-16 fa-7x"
          >
            <g class="fa-group">
              <path
                fill="currentColor"
